...
import * as flic from "flic";
import * as config from "./util/config";
import * as pluginName from "./custom/name";
import * as onheartbeat from "./custom/onheartbeat";
import * as onload from "./custom/onload";
import * as ontick from "./custom/ontick";
import * as onbar from "./custom/onbar";
import * as ontransaction from "./custom/ontransaction";
import * as onunload from "./custom/onunload";
